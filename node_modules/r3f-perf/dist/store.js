...
const usePerfImpl = traditional.createWithEqualityFn((set, get) => {
  function getReport() {
    var _a;
...
const usePerf = (sel) => usePerfImpl(sel, shallow.shallow);
...
exports.setPerf = setPerf;
exports.usePerf = usePerf;
exports.usePerfImpl = usePerfImpl;
